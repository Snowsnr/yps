          ...
          System.out.println(usuario);
            String driver="com.mysql.jdbc.Driver";
                                ...
                                try{
                                    ...
                                    rs=st.executeQuery("Select producto.id_producto, material.Material, producto.Ubimagen, producto.Precio from material INNER JOIN producto ON producto.id_material=material.id_material WHERE producto.id_papeleria="+idp+"");
